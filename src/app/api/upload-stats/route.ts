...
async function updateHourlyStats(userId: string, periodStart: Date, periodEnd: Date, messageType: string, stats: MessageStats) {
  ...
  const statsData = {
    periodStart,
    periodEnd,
    totalToolsCalled: stats.toolsUsed,
    totalMessagesSent: stats.messagesCount,
    totalInputTokens: BigInt(stats.inputTokens),
    totalOutputTokens: BigInt(stats.outputTokens),
    totalCacheCreationTokens: BigInt(stats.cacheCreationTokens),
    totalCacheReadTokens: BigInt(stats.cacheReadTokens),
    totalCost: stats.cost,
    totalFilesRead: stats.filesRead,
    totalFilesEdited: stats.filesEdited,
    totalFilesWritten: stats.filesWritten,
    totalLinesRead: BigInt(stats.linesRead),
    totalLinesEdited: BigInt(stats.linesEdited),
    totalLinesWritten: BigInt(stats.linesWritten),
    totalBytesRead: BigInt(stats.bytesRead),
    totalBytesEdited: BigInt(stats.bytesEdited),
    totalBytesWritten: BigInt(stats.bytesWritten),
    totalTerminalCommands: stats.terminalCommands,
    totalGlobSearches: stats.globSearches,
    totalGrepSearches: stats.grepSearches,
    totalTodosCreated: stats.todosCreated,
    totalTodosCompleted: stats.todosCompleted,
    totalTodosInProgress: stats.todosInProgress,
    totalTodoWrites: stats.todoWrites,
    totalTodoReads: stats.todoReads,
  };
  ...
  if (!existingStats || existingStats.periodStart.getTime() !== periodStart.getTime()) {
    ...
    await db.userHourlyStats.update({
      where: { userId },
      data: {
        totalToolsCalled: existingStats.totalToolsCalled + stats.toolsUsed,
        totalMessagesSent: existingStats.totalMessagesSent + stats.messagesCount,
        totalInputTokens: existingStats.totalInputTokens + BigInt(stats.inputTokens),
        totalOutputTokens: existingStats.totalOutputTokens + BigInt(stats.outputTokens),
        totalCacheCreationTokens: existingStats.totalCacheCreationTokens + BigInt(stats.cacheCreationTokens),
        totalCacheReadTokens: existingStats.totalCacheReadTokens + BigInt(stats.cacheReadTokens),
        totalCost: existingStats.totalCost + stats.cost,
        totalFilesRead: existingStats.totalFilesRead + stats.filesRead,
        totalFilesEdited: existingStats.totalFilesEdited + stats.filesEdited,
        totalFilesWritten: existingStats.totalFilesWritten + stats.filesWritten,
        totalLinesRead: existingStats.totalLinesRead + BigInt(stats.linesRead),
        totalLinesEdited: existingStats.totalLinesEdited + BigInt(stats.linesEdited),
        totalLinesWritten: existingStats.totalLinesWritten + BigInt(stats.linesWritten),
        totalBytesRead: existingStats.totalBytesRead + BigInt(stats.bytesRead),
        totalBytesEdited: existingStats.totalBytesEdited + BigInt(stats.bytesEdited),
        totalBytesWritten: existingStats.totalBytesWritten + BigInt(stats.bytesWritten),
        totalTerminalCommands: existingStats.totalTerminalCommands + stats.terminalCommands,
        totalGlobSearches: existingStats.totalGlobSearches + stats.globSearches,
        totalGrepSearches: existingStats.totalGrepSearches + stats.grepSearches,
        totalTodosCreated: existingStats.totalTodosCreated + stats.todosCreated,
        totalTodosCompleted: existingStats.totalTodosCompleted + stats.todosCompleted,
        totalTodosInProgress: existingStats.totalTodosInProgress + stats.todosInProgress,
        totalTodoWrites: existingStats.totalTodoWrites + stats.todoWrites,
        totalTodoReads: existingStats.totalTodoReads + stats.todoReads,
      }
    });
  }
}
      ...
      if ("AI" in message && message.AI) {
        ...
        await db.userEvents.create({
          data: {
            ...
            linesRead: BigInt(fileOperations?.linesRead || 0),
            linesEdited: BigInt(fileOperations?.linesEdited || 0),
            linesWritten: BigInt(fileOperations?.linesWritten || 0),
            bytesRead: BigInt(fileOperations?.bytesRead || 0),
            bytesEdited: BigInt(fileOperations?.bytesEdited || 0),
            bytesWritten: BigInt(fileOperations?.bytesWritten || 0),
        ...
        await db.userEvents.create({
          data: {
            ...
            filesWritten: 0,
            linesRead: BigInt(0),
            linesEdited: BigInt(0),
            linesWritten: BigInt(0),
            bytesRead: BigInt(0),
            bytesEdited: BigInt(0),
